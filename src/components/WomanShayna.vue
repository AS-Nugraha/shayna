                ...
                <div class="col-lg-12 mt-5" v-if="products.length > 0">
                    <carousel class="product-slider" :dots="false" :autoplay="true" :nav="false">
                        <div class="product-item" v-for="itemProduct in products" v-bind:key="itemProduct.id">
                            <div class="pi-pic">
                                <img class="gallery" :src="itemProduct.galleries[0] ? itemProduct.galleries[0].photo : 'img/mickey1.jpg'" alt="" />
                                <ul>
                            ...
                            <div class="pi-text">
                                ...
                                <router-link v-bind:to="'/product/'+itemProduct.id"><h5>{{ itemProduct.name }}</h5></router-link>
...
export default {
    ...
    mounted() {
        ...
        axios
            .get('http://localhost/VUE/shayna-backend/public/api/products')
