                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover">
                                        ...
                                        <table>
                                            <tbody v-if="keranjangUser.length > 0">
                                                <tr v-for="keranjang in keranjangUser" :key="keranjang.id">
                                                    ...
                                                    <td class="si-close">
                                                        <i @click="removeItem(keranjangUser.index)" class="ti-close"></i>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <tbody v-else>
                                    ...
                                    <div class="select-button">
                                        <a href="#" class="primary-btn view-card"><router-link to="/cart" class="text-white">VIEW CARD</router-link></a>
...
export default {
    ...
    methods: {
        removeItem(idx) {
            ...
            // cocokan idx item dengan id yg ada di local storage
